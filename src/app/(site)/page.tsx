...
const whyUs = [
  { icon: HelpCircle,        title: ' مشاوره رایگان',       desc: 'تحلیل تخصصی موضوع شما بدون هزینه، اولین گام برای انتخاب آگاهانه پیش از انعقاد قرداد' },
  { icon: HeartHandshake,        title: 'همراه با موکل',      desc: 'پشتیبانی گام به گام و گزارش دهی مستمر از روند پیشرفت کار در تمام مراحل دادرسی و جلسات قضایی' },
  { icon: CheckCircle2, title: 'اعلام وکالت',     desc: 'ورود رسمی به پرونده و آغاز پیگیری جدی و قانونی در پرونده پس از تفویض اختیار وکالت' },
]
            ...
            <div className="text-center lg:text-right">
              ...
              <div className="flex flex-wrap gap-3 mb-14 animate-fade-in-up delay-300">
                ...
                <Link href="tel:09120310806"
                  ...
                  <Link href="/qa"
                    className="inline-flex bg-gradient-to-b from-[#b09b52] to-[#8a7840] border-2 border-[#d4be6e] bg-[#9e8b47] border-2 border-[#c9b36b] text-white font-bold py-2 px-8 rounded-full shadow-inner backdrop-blur-sm transition hover:bg-[#b09b52] hover:border-[#dfcc88] hover:shadow-gold">
                    <Scale size={17} />
                  پرسش از وکیل
                </Link>
              </div>
