        ...
        <div className="container-site">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p>من علیرضا نظری هستم، وکیل پایه یک دادگستری و مؤسس این مجموعه حقوقی در شیراز. </p>
...
در این مجموعه تلاش کرده‌ایم فضایی فراهم کنیم تا موکل با خیال راحت مسائل حقوقی خود را مطرح کند.
              ...
              <p className='text-gold font-bold'>مشاوره حقوقی رایگان انجام می‌شود تا قبل از هر تصمیمی، موضوع به‌طور کامل بررسی شود.</p>
