...
const positions = [
  {
    ...
    requirements: ['آشنایی با نرم‌افزارهای اداری', 'توانایی مدیریت زمان', 'مهارت ارتباطی قوی', 'حداقل دیپلم'],
  },
  {
    id: 'intern',
    icon: GraduationCap,
    title: 'کارآموز حقوقی',
    type: 'پاره وقت',
    description: 'همکاری در تحقیقات حقوقی، تهیه لوایح و آشنایی با فرآیندهای دادرسی زیر نظر وکیل ارشد.',
    requirements: ['دانشجوی حقوق (ترم ۵ به بالا)', 'آشنایی با قوانین اساسی', 'اشتیاق به یادگیری', 'دقت بالا'],
  },
  {
    id: 'lawyer',
    icon: Star,
    title: 'وکیل ارشد همکار',
    type: 'همکاری پروژه‌ای',
    description: 'همکاری در پرونده‌های تخصصی حقوقی، کیفری و خانواده با تجربه حداقل ۵ سال وکالت.',
    requirements: ['پروانه وکالت معتبر', 'حداقل ۵ سال سابقه', 'تخصص در یک حوزه', 'آشنایی با دادگاه‌های شیراز'],
  },
]
