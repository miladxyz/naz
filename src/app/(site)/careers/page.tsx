...
const positions = [
  {
    ...
    requirements: ['حفظ اصل محرمانگی', 'سامانه  ابلاغ','سامانه خودکاربری وکیل', 'آشنایی با نرم‌افزارهای اداری', 'توانایی مدیریت زمان', 'مهارت ارتباطی قوی' ,'دانشجوی حقوق'],
  },
  {
    id: 'intern',
    icon: GraduationCap,
    ...
    requirements: [ 'فعالیت در دفتر و خارج از دفتر','پروانه وکالت معتبر', 'تخصص در چند حوزه', 'آشنایی با دادگاه‌های شیراز'],
  },
]
